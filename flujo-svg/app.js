...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ACCIONES": () => (/* binding */ ACCIONES),
/* harmony export */   "ACCIONES499": () => (/* binding */ ACCIONES499),
/* harmony export */   "ACCIONES532": () => (/* binding */ ACCIONES532),
/* harmony export */   "ACCIONES361": () => (/* binding */ ACCIONES361),
/* harmony export */   "ACCIONES1": () => (/* binding */ ACCIONES1),
/* harmony export */   "ACCIONES599": () => (/* binding */ ACCIONES599)
/* harmony export */ });
var ACCIONES = []; // :::::::::::::::::::::::::::::::::::::::::id_trabajo=499
...
var ACCIONES532 = [{
  ...
  //->actor
  nodo_fin: 959,
  //-no se usa, usar id_flujo_(si/no)
  unidad_plazo: null,
  tipo_flujo: 32929,
  flag_firma: null,
  flag_sugerido: null,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ACTORES499": () => (/* binding */ ACTORES499),
/* harmony export */   "ACTORES532": () => (/* binding */ ACTORES532),
/* harmony export */   "ACTORES361": () => (/* binding */ ACTORES361),
/* harmony export */   "ACTORES1": () => (/* binding */ ACTORES1),
/* harmony export */   "ACTORES599": () => (/* binding */ ACTORES599)
/* harmony export */ });
var ACTORES499 = [{
  codigo: 942,
  descripcion: "SCG - ZONA DE REVISION FISICA ZRF",
  id_estructura: null,
  flag_ficticio: 0,
  id_grupo: 335,
  flujo: false,
  ...
  codigo: 936,
  descripcion: "DGA - ZONA DE REVISION FISICA ZRF",
  id_estructura: 1608,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
  ...
  codigo: 937,
  descripcion: "IPSA- CANAL DESPACHO EXPEDITO CDE",
  id_estructura: 1581,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
  ...
  codigo: 938,
  descripcion: "DGME - CANAL DESPACHO EXPEDITO CDE",
  id_estructura: 1579,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
  ...
  codigo: 939,
  descripcion: "PN - CANAL DESPACHO EXPEDITO CDE",
  id_estructura: 1577,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
  ...
  codigo: 940,
  descripcion: "DGA - CANAL DESPACHO EXPEDITO CDE",
  id_estructura: 1575,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
...
var ACTORES532 = [{
  ...
  codigo: 963,
  descripcion: "DGA - ZONA ESTACIONAMIENTO PREVIO ZEP",
  id_estructura: 1576,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
...
var ACTORES361 = [{
  ...
  codigo: 1072,
  descripcion: "IPSA - ZONA ESTACIONAMIENTO PREVIO ZEP",
  id_estructura: 1582,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
  ...
  codigo: 1074,
  descripcion: "DGME - ZONA ESTACIONAMIENTO PREVIO ZEP",
  id_estructura: 1580,
  flag_ficticio: 0,
  id_grupo: null,
  flujo: false,
...
var ACTORES1 = [{
  "codigo": 465,
  "descripcion": "DIRECCIÓN GENERAL DE TRIBUTACIÓN",
  "id_estructura": 27,
  "flag_ficticio": 0,
  "id_grupo": null,
  "flujo": false,
  ...
  "codigo": 442,
  "descripcion": "SERVICIO NACIONAL DE SALUD",
  "id_estructura": 258,
  "flag_ficticio": 0,
  "id_grupo": null,
  "flujo": false,
...
/* harmony import */ var _actores__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./actores */ "./src/flujo-svg/actores.js");
/* harmony import */ var _acciones__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./acciones */ "./src/flujo-svg/acciones.js");



var diagrama = {
  title: "Anima tu página con SVG, CSS y JavaScript",
  actores: _actores__WEBPACK_IMPORTED_MODULE_1__.ACTORES361.filter(function (i) {
    return i.flag_ficticio == 0;
  }).sort(function (a, b) {
    return a.orden - b.orden;
  }),
  acciones: _acciones__WEBPACK_IMPORTED_MODULE_2__.ACCIONES361.sort(function (a, b) {
    return a.orden - b.orden;
  })
};
var accionDrawWidth = 150;
var accionDrawHeight = 60;
var heightActores = 200;
var widthActores = 300 + diagrama.acciones.length * 200; //(x_start_Accion+#Acciones * accionDrawWidth)

var drawHeight = heightActores * diagrama.actores.length;
var x_start_accion = 300;
var lineStroke = {
  color: "#000",
  width: 1,
  linecap: "round"
};
var draw = (0,_svgdotjs_svg_js__WEBPACK_IMPORTED_MODULE_0__.SVG)().addTo("#drawing");
draw.size(widthActores + 50, drawHeight);
var accionesDibujadas = []; // guarda el id de la accion y sus coordenadas x,y de su centro {id_flujo,x,y}
...
function dibujarTitulo() {
  ...
  group.rect(50, drawHeight).fill("white").stroke({
    color: "black",
    width: 1
  }).move(0, 0);
  var texto_autor = group.text(diagrama.title).move(15, drawHeight / 2).font({
    family: "Arial, sans-serif",
    size: "12px"
  }).fill("black").stroke("none");
  var texto_height = texto_autor.bbox().height;
...
function dibujarActores() {
  var hx = 0;
  diagrama.actores.forEach(function (item) {
    var group = draw.group();
    group.rect(widthActores, heightActores).fill("white").stroke({
      color: "black",
      width: 1
    }).move(50, hx);
    hx += heightActores;
    var texto_autor = group.text(jumplineActorNombre(item.descripcion)).move(70, hx - 100).font({
      family: "Arial, sans-serif",
      size: "10px"
    }).fill("black").stroke("none");
    var texto_height = texto_autor.bbox().height;
...
function jumplineActorNombre(descripcion) {
  var resultado = "";
  var contador = 0;
  descripcion.split(" ").forEach(function (palabra) {
...
function jumplineMaxLength(text) {
  ...
  var resultado = "";
  var contador = 0;
  text.split(" ").forEach(function (palabra) {
...
function dibujarAcciones() {
  ...
  var accion_inicial = diagrama.acciones.find(function (accion) {
    return accion.tipo_flujo_ca == "I";
  });
  ...
  var indexActorInicial = diagrama.actores.findIndex(function (actor) {
    return actor.codigo == accion_inicial.nodo_fin;
  });
  ...
  showCuadricula(); //dibuja nodo inicial
  //se empieza a graficar a partir de las COORDENADAS 200,0

  var groupInicio = draw.group();
  diagrama.acciones.forEach(function (accion, i) {
    if (accionesDibujadas.find(function (item) {
      return item.id_flujo == accion.id_flujo;
    })) {
      return;
    }
    ...
    if (i == 0) {
      ...
      groupInicio.circle().radius(25).stroke({
        color: "#70b22c",
        width: 2
      }).fill("#e6ff97");
      var index_actor = diagrama.actores.findIndex(function (item) {
        return item.codigo == accion.nodo_fin;
      });
      groupInicio.move(175, 100 + index_actor * 200 - 25);
    } else {
      switch (accion.tipo_flujo_ca) {
        case "E":
          var index_actor_inicio = diagrama.actores.findIndex(function (item) {
            return item.codigo == accion.nodo_inicio;
          });
          var index_actor_fin = diagrama.actores.findIndex(function (item) {
            return item.codigo == accion.nodo_fin;
          });
...
function dibujarFinal(accion) {
  ...
  var accion_proveniente = accion.flujos_provenientes[0]; //console.log('accion_proveniente',accion_proveniente);

  var _accionesDibujadas$fi = accionesDibujadas.find(function (x) {
    return x.id_flujo == accion_proveniente;
  }),
      x = _accionesDibujadas$fi.x,
      y = _accionesDibujadas$fi.y;

  draw.circle(50).stroke({
    color: "#861e20",
    width: 2
  }).fill("#f5d1cf").center(x + 150, y); //conectorProveniente(x + 125, y, accion.flujos_provenientes);
}
/**
...
function drawConectorLeft(x, y, tipo_para_nom) {
  ...
  //linea
  var conectorLeft = draw.line(x - 125, y, x, y).stroke(lineStroke); //triangulo (flecha)

  draw.polygon("9,5 0,0 0,10").fill("#000").move(x - 9, y - 5); //text

  if (tipo_para_nom) {
    var texto_autor = draw.text(tipo_para_nom).move(x - 75, y).font({
      family: "Arial, sans-serif",
      size: "10px"
...
function dibujarRectAccion(accion, i, index_actor_inicio, index_actor_fin) {
  var text_proveniente = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
  var y_start_accion = 100 + index_actor_inicio * 200;
  drawConectorLeft(x_start_accion, y_start_accion, i == 1 ? "" : accion.tipo_para_nom); //dibuja cuadro y texto de la accion

  var accionDraw = draw.group();
  accionDraw.rect(accionDrawWidth, accionDrawHeight).radius(8).stroke({
    color: "#10709f",
    width: 2
  }).fill("#eceeff");
  var texto_autor = accionDraw.text(jumplineMaxLength(accion.id_flujo + " - " + accion.descripcion)).font({
    family: "Arial, sans-serif",
    size: "10px"
  }).fill("black").stroke("none").move(75, 15);
  texto_autor.attr("text-anchor", "middle");
  ...
  accionesDibujadas.push({
    ...
    x: x_start_accion + accionDrawWidth / 2,
    y: y_start_accion
  });
...
function conectorProveniente(x_start, y_start) {
  var flujos_provenientes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  ...
  flujos_provenientes.forEach(function (element) {
    var accion = accionesDibujadas.find(function (item) {
      return item.id_flujo == element;
    });

    if (accion) {
      var x = accion.x,
          y = accion.y;
      var conector = draw.line(x_start, y_start, x, y).stroke({
        color: color,
        width: 1,
        linecap: "round"
      });
      ...
      if (text) {
        var x_punto_medio = (x_start + x) / 2;
        var y_punto_medio = (y_start + y) / 2;
        var accionDraw = draw.group();
        var texto = accionDraw.text(text).font({
          family: "Arial, sans-serif",
          size: "14px"
        }).fill("black").stroke("none").move(75, 15);
...
function conectorNext(index_actor_inicio, index_actor_fin, y_start_accion) {
  var resto_indexs = Math.abs(index_actor_inicio - index_actor_fin) - 1;
  var lineHeigth = 200 + resto_indexs * 200;
  var conectorNext = draw.line(0, 0, 0, lineHeigth).stroke(lineStroke);
...
function dibujarCondicional(accion, i) {
  ...
  var accion_next_si = diagrama.acciones.find(function (a) {
    return a.id_flujo == accion.id_flujo_si;
  });
  var index_actor_fin = diagrama.actores.findIndex(function (item) {
    return item.codigo == accion_next_si.nodo_fin;
  });
  var y_start_accion = 100 + index_actor_inicio * 200;
  drawConectorLeft(x_start_accion, y_start_accion, ""); // DIBUJA CONDICIONAL

  draw.polygon("0,25 25,50 50,25 25,0").stroke({
    color: "#afb42e",
    width: 2
  }).fill("#ffffcb").move(x_start_accion, y_start_accion - 25); //x_start_accion -= 50;
  ...
  var x_start_accion_local = x_start_accion; //ACCION SI conectorNext

  var accion_si = diagrama.acciones.find(function (item) {
    return item.id_flujo == accion.id_flujo_si;
  });

  if (accion_si) {
    switch (accion_si.tipo_flujo_ca) {
      case "E":
        index_actor_inicio = diagrama.actores.findIndex(function (item) {
          return item.codigo == accion_si.nodo_fin;
        });
        index_actor_fin = diagrama.actores.findIndex(function (item) {
          return item.codigo == accion_si.nodo_inicio;
        });
  ...
  var accion_no = diagrama.acciones.find(function (item) {
    return item.id_flujo == accion.id_flujo_no;
  });

  if ((accion_no === null || accion_no === void 0 ? void 0 : accion_no.tipo_flujo_ca) == 'E') {
    switch (accion_no.tipo_flujo_ca) {
      case "E":
        index_actor_inicio = diagrama.actores.findIndex(function (item) {
          return item.codigo == accion_no.nodo_fin;
        });
        index_actor_fin = diagrama.actores.findIndex(function (item) {
          return item.codigo == accion_no.nodo_inicio;
        });
...
function showCuadricula() {
  ...
  for (var index = 0; index < 4 * diagrama.acciones.length; index++) {
    draw.line(startX, 0, startX, drawHeight).stroke({
      color: "#cacaca",
      width: 1,
      linecap: "round"
    });
  ...
  for (var _index = 0; _index < 4 * diagrama.actores.length; _index++) {
    draw.line(200, startY, widthActores, startY).stroke({
      color: "#cacaca",
      width: 1,
      linecap: "round"
    });
